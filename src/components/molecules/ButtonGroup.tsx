  ...
  return (
    <div className="flex flex-col md:flex-col lg:flex-row gap-6 md:justify-between items-center">
        <div className="flex flex-col gap-2 md:flex-row">
          <AppButton className={cn("bg-primary-one cursor-pointer")}>
          ...
          <AppButton
            className={cn(
              "bg-indigo-50 border border-brand  hover:bg-blue-200 cursor-pointer "
            )}
          >
            <div className="flex gap-2 items-center text-[#00648A] ">
              <span>
                <Mail></Mail>
              </span>
          ...
          <AppButton
            variant="destructive"
            className={cn("hover:bg-red-500 cursor-pointer")}
          >
            <div className="flex gap-2 items-center ">
              <span>
                <CircleX />
        ...
        <AppButton
          className={cn("bg-reapply-button hover:bg-green-800 cursor-pointer")}
        >
          <span>
            <RotateCw />
          </span>
