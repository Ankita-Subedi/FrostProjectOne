...
const LCCard = ({
  ...
  return (
    <Card className={cn("w-[554px] shadow-xl border-none  py-2")}>
      <CardHeader>
        <CardTitle
          className={cn("text-primary-one text-[24px]/[28px] font-bold")}
        >
          {" "}
          {title}
        </CardTitle>
        <CardDescription className={cn("text-[14px] text-[#3C4144]")}>
          {description}
        </CardDescription>
      </CardHeader>
      ...
      <CardFooter className={cn("flex flex-col w-full  mx-auto")}>
        <div className="w-full grid  grid-cols-2 gap-1 items-center mx-auto ">
          <div className="flex flex-col">
            <AppButton className={cn("bg-brand ")}>
              <div className="flex gap-1 items-center ">
                <Plus />
                <span className="font-normal text-[18px]">
                  Apply blank application
                </span>
              </div>
            </AppButton>
            <span className="text-[12px] text-[#AFAFAF]">
              Manually fill out form fields
            </span>
          </div>

          <div className="flex flex-col justify-center ">
            {/* <DropDownFrost></DropDownFrost> */}
            <span className="text-[12px] text-[#AFAFAF] ml-3">
              Auto fill fields using AI
            </span>
          </div>
        </div>
      </CardFooter>
